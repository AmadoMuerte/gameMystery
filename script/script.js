...
let checkAns = function(riddles, ans) {
    if (div.textContent == riddles[0] && game.answer.value == ans[0]) {
        win();
    } else if (div.textContent == riddles[1] && game.answer.value == ans[1]) {
        win();
    } else if (div.textContent == riddles[2] && game.answer.value == ans[2]) {
        win();
    } else if (div.textContent == riddles[3] && game.answer.value == ans[3]) {
        win();
